        ...
        <Box sx={{ pb: 7 }} ref={ref}>
            <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0 }} elevation={3}>
                <BottomNavigation showLabels>
                    <BottomNavigationAction sx={{ color: "inherit" }} onClick={() => router.push('/videoCall')} label="Video call" icon={<CallOutlinedIcon />} />
                    ...
                    <BottomNavigationAction sx={{ color: "inherit" }}  onClick={() => router.push('/settings')} label="Settings" icon={<SettingsOutlinedIcon />} />
                </BottomNavigation>
            </Paper>
        </Box>
    );
